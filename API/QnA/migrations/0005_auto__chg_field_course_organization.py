...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.organization'
        db.alter_column('QnA_courses', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QnA.Organization'], null=True))

    def backwards(self, orm):

        # Changing field 'Course.organization'
        db.alter_column('QnA_courses', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['QnA.Organization']))
