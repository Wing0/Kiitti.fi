...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.organization_id'
        db.add_column(u'QnA_organization', 'organization_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=123, unique=True),
                      keep_default=False)

        # Deleting field 'User.organization_id'
        db.delete_column(u'QnA_user', 'organization_id_id')

        # Adding field 'User.organization'
        db.add_column(u'QnA_user', 'organization',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QnA.Organization'], to_field='organization_id', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.organization_id'
        db.delete_column(u'QnA_organization', 'organization_id')

        # Adding field 'User.organization_id'
        db.add_column(u'QnA_user', 'organization_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QnA.Organization'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'User.organization'
        db.delete_column(u'QnA_user', 'organization_id')
