...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AbstractMessage.organization'
        db.add_column(u'QnA_abstractmessage', 'organization',
    ...
    def backwards(self, orm):
        # Deleting field 'AbstractMessage.organization'
        db.delete_column(u'QnA_abstractmessage', 'organization_id')
