...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AbstractMessage.modified'
        db.delete_column(u'QnA_abstractmessage', 'modified')


    def backwards(self, orm):
        # Adding field 'AbstractMessage.modified'
        db.add_column(u'QnA_abstractmessage', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 1, 25, 0, 0), blank=True),
                      keep_default=False)
