...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'QnA_vote', 'user_id_id')

        # Adding field 'Vote.user'
        db.add_column(u'QnA_vote', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['QnA.User'], to_field='user_id'),
                      keep_default=False)

        # Deleting field 'AbstractMessage.user_id'
        db.delete_column(u'QnA_abstractmessage', 'user_id_id')

        # Adding field 'AbstractMessage.user'
        db.add_column(u'QnA_abstractmessage', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['QnA.User'], to_field='user_id'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'QnA_vote', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['QnA.User'], to_field='user_id'),
                      keep_default=False)

        # Deleting field 'Vote.user'
        db.delete_column(u'QnA_vote', 'user_id')

        # Adding field 'AbstractMessage.user_id'
        db.add_column(u'QnA_abstractmessage', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=123, to=orm['QnA.User'], to_field='user_id'),
                      keep_default=False)

        # Deleting field 'AbstractMessage.user'
        db.delete_column(u'QnA_abstractmessage', 'user_id')
