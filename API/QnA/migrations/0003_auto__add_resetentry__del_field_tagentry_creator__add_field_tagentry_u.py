...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TagEntry.creator'
        db.delete_column(u'QnA_tagentry', 'creator_id')

        # Adding field 'TagEntry.user'
        db.add_column(u'QnA_tagentry', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['QnA.User'], to_field='user_id'),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TagEntry.creator'
        db.add_column(u'QnA_tagentry', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=10, to=orm['QnA.User'], to_field='user_id'),
                      keep_default=False)

        # Deleting field 'TagEntry.user'
        db.delete_column(u'QnA_tagentry', 'user_id')
    ...
    models = {
        ...
        u'QnA.vote': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_question': ('django.db.models.fields.BooleanField', [], {}),
            'message_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'modified': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['QnA.User']", 'to_field': "'user_id'"})
        },
