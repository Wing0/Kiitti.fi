...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AbstractMessage.organization'
        db.alter_column(u'QnA_abstractmessage', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QnA.Organization'], to_field='organization_id'))

        # Changing field 'User.organization'
        db.alter_column(u'QnA_user', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QnA.Organization'], to_field='organization_id'))

    def backwards(self, orm):

        # Changing field 'AbstractMessage.organization'
        db.alter_column(u'QnA_abstractmessage', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QnA.Organization'], to_field='organization_id', null=True))

        # Changing field 'User.organization'
        db.alter_column(u'QnA_user', 'organization_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['QnA.Organization'], to_field='organization_id', null=True))
