...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Course', fields ['name', 'organization']
        db.create_unique('QnA_courses', ['name', 'organization_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Course', fields ['name', 'organization']
        db.delete_unique('QnA_courses', ['name', 'organization_id'])
