...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'QnA', ['Course'])

        # Adding M2M table for field categories on 'Course'
        m2m_table_name = db.shorten_name('QnA_courses_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm[u'QnA.course'], null=False)),
            ('category', models.ForeignKey(orm[u'QnA.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['course_id', 'category_id'])

        # Adding M2M table for field moderators on 'Course'
        m2m_table_name = db.shorten_name('QnA_courses_moderators')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm[u'QnA.course'], null=False)),
        ...
        # Adding M2M table for field categories on 'Keyword'
        m2m_table_name = db.shorten_name('QnA_keywords_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('QnA_courses')

        # Removing M2M table for field categories on 'Course'
        db.delete_table(db.shorten_name('QnA_courses_categories'))

        # Removing M2M table for field moderators on 'Course'
        db.delete_table(db.shorten_name('QnA_courses_moderators'))
        ...
        # Removing M2M table for field categories on 'Keyword'
        db.delete_table(db.shorten_name('QnA_keywords_categories'))
    ...
    models = {
        ...
        u'QnA.course': {
            'Meta': {'object_name': 'Course', 'db_table': "'QnA_courses'"},
