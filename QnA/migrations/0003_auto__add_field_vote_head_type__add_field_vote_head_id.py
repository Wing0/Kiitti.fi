...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.head_type'
        db.add_column('QnA_votes', 'head_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=13, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Vote.head_id'
        db.add_column('QnA_votes', 'head_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=30),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.head_type'
        db.delete_column('QnA_votes', 'head_type_id')

        # Deleting field 'Vote.head_id'
        db.delete_column('QnA_votes', 'head_id')
