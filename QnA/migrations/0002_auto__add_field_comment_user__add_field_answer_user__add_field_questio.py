...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('QnA_comments', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QnA.User']),
                      keep_default=False)

        # Adding field 'Answer.user'
        db.add_column('QnA_answers', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QnA.User']),
                      keep_default=False)

        # Adding field 'Question.user'
        db.add_column('QnA_questions', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['QnA.User']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('QnA_comments', 'user_id')

        # Deleting field 'Answer.user'
        db.delete_column('QnA_answers', 'user_id')

        # Deleting field 'Question.user'
        db.delete_column('QnA_questions', 'user_id')
